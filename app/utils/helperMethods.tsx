...
import { Booking, Room } from "../services/apiClient";
...
export const generateHours = (startHour: number, endHour: number): string[] => {
  const hours: string[] = [];
...
export const isRoomBooked = (room: Room, date: Date, hour: string): boolean => {
